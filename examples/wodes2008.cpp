...
int main()
{
	...
	std::cout << " pAlpha1 :" << std::endl
			  << pAlpha1 << std::endl;
	std::cout << " pAlpha2 :" << std::endl
			  << pAlpha2 << std::endl;
	std::cout << " pAlpha3 :" << std::endl
			  << pAlpha3 << std::endl;
	std::cout << " pAlpha4 :" << std::endl
			  << pAlpha4 << std::endl;
	...
	std::cout << " Alpha14 :" << std::endl
			  << Alpha14 << std::endl;

	getchar();

	y3bis = odot(oplus(Alpha14.getp(), Alpha14.getq()), pAlpha4);
	if (oplus(y3, y3bis) == y3bis)
		std::cout << " OK y3 " << std::endl;
	u3bis = frac(y3bis, beta3);
	if (oplus(u3, u3bis) == u3bis)
		std::cout << " OK u3 " << std::endl;
	y2bis = odot(oplus(u3bis.getp(), u3bis.getq()), pAlpha3);
	if (oplus(y2, y2bis) == y2bis)
		std::cout << " OK y2 " << std::endl;
	u2bis = frac(y2bis, beta2);
	if (oplus(u2, u2bis) == u2bis)
		std::cout << " OK u2 " << std::endl;
	y1bis = fracodotsharp(oplus(u2bis.getp(), u2bis.getq()), pAlpha2);
	if (oplus(y1, y1bis) == y1bis)
		std::cout << " OK y1 " << std::endl;
	// y1bis=fracodotsharp(odot(oplus(y1.getp(),y1.getq()),pAlpha2),pAlpha2);
	u1bis = frac(y1bis, beta1);
	if (oplus(u1, u1bis) == u1bis)
		std::cout << " OK u1 " << std::endl;
	Alpha11 = fracodotsharp(oplus(u1bis.getp(), u1bis.getq()), pAlpha1);

	std::cout << " y3bis :" << std::endl
			  << y3bis << std::endl;
	std::cout << " u3bis :" << std::endl
			  << u3bis << std::endl;
	std::cout << " y2bis :" << std::endl
			  << y2bis << std::endl;

	std::cout << " u2bis :" << std::endl
			  << u2bis << std::endl;

	std::cout << " y1 :" << std::endl
			  << y1 << std::endl;
	std::cout << " y1bis :" << std::endl
			  << y1bis << std::endl;

	std::cout << " u1bis :" << std::endl
			  << u1bis << std::endl;
	std::cout << " Alpha11:" << std::endl
			  << Alpha11 << std::endl;
	...
	/*
		...
		Alpha11=oplus(epoly,gd(30,infinity)); // On met e en entr�e
	...
	*/
	...
	std::cout << " p2 :" << std::endl
			  << p2 << std::endl;
	std::cout << " p3 =fracodotflat(p1,p2);" << std::endl
			  << p3 << std::endl;
	std::cout << " p  =odot(p3,p2);:" << std::endl
			  << p << std::endl;
	/*
